...
# images
img_1 = Image.open('images/icon2.png')
...
img_2 = Image.open('images/icon5.png')
...
img_3 = Image.open('images/icon6.png')
img_3 = img_3.resize((30, 30))
img_3 = ImageTk.PhotoImage(img_3)
previous_button = Button(down_frame, width=40, height=40, image=img_3, padx=10, bg=co1, font="Ivy 10",
                         command=prev_music)
previous_button.place(x=10 + 28, y=35)

img_4 = Image.open('images/icon3.png')
...
img_5 = Image.open('images/icon4.png')
...
img_6 = Image.open('images/icon1.png')
...
img_7 = Image.open('images/icon7.png')
...
os.chdir(r'C:\Users\Rares\PycharmProjects\pythonProject3\music')
songs = os.listdir()
